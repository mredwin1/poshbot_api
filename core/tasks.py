        ...
        with PoshMarkClient(self.campaign, self.logger) as client:
            ...
            if logged_in:
                ...
                if random_number < 0.1:
                    ...
                    reported_item_ids = ListedItemReport.objects.filter(posh_user=self.campaign.posh_user).values_list('listed_item_to_report__listed_item_idreport__listed_item_id', flat=True)
